...
When we adopt a tool we also adopt the management philosophy embedded in that tool. Twitter is training the users towards conciseness and calamity. Our daily practice of expressivity and integrity on social media is improving our use of language, actions and personalities and swiftly lead to evolution of the society beyond traditional expectations.
