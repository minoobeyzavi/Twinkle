...
Twinkle is a Natural Language Processing model capable of processing a growing database of billions of tweets and finding the most similar tweet instantly. This model computes similarities in real-time using a hashing vectorizer and a Locality Sensitive Hashing Forest sequentially to achieve sub-linear scaling of computation time.
