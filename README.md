...
When we adopt a tool we also adopt the management philosophy embedded in that tool. Twitter has been coaching social media users and consequently the news audience worldwide towards conciseness and expressivity. Our continuous practice in use of language on social media is improving our integrity and refining our actions and personalities. Twitter's super power is to quickly spread information, hosting effective conversations and advancing the evolution of the society beyond traditional expectations.
