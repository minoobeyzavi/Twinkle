...
When we adopt a tool we also adopt the management philosophy embedded in that technology. Twitter is training users across the globe towards conciseness and expressivity. Our incessant practice of integrity in use of language on social media is improving and refining our actions and personalities; swiftly leading to evolution of the society beyond traditional expectations. Twitter purifies the momentum and makes it far more tangible.
